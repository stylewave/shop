                ...
                <div class="flexilist">
                    ...
                    <div class="common-content goods_info">
                        ...
                        <div class="step step_two" style="display:none;" ectype="step" data-step="3">
                            ...
                            <div class="sort_tit">
                                <strong>您常用的商品分类：</strong>
                                <div class="select_list select_w320" id="sortcommList">
                                    <div class="cite">请选择</div>
                                    <ul>
                                        <li><a href="javascript:void(0);" data-value="0">请选择</a></li>
                                        <?php $_from = $this->_var['common_category']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'category_0_44447600_1522815325');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['category_0_44447600_1522815325']):
?>
                                        <li><a href="javascript:void(0);" data-value="<?php echo $this->_var['key']; ?>"><?php echo $this->_var['category_0_44447600_1522815325']; ?></a></li>
                                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                    </ul>
                                	<input name="common_category" type="hidden" value="" id="sortcommValue">
                                </div>
                            </div>
                            <!--<?php else: ?>-->
				...
				<?php if ($this->_var['goods']['goods_id'] == ""): ?>  <a href="javascript:void(0);" class="btn btn35 blue_btn" data-step="8" data-type="caiji" data-down="true" ectype="stepSubmit">采集淘宝</a><?php endif; ?>
                            	<?php if ($this->_var['goods']['goods_id']): ?><a href="javascript:void(0);" class="btn btn35 blue_btn" data-down="true" data-type="submit" ectype="stepSubmit"><i class="sc_icon goods_complete_icon"></i>完成，发布商品</a><?php endif; ?>
                            </div>
                        </div>
                            ...
                            <div class="step">
                                ...
                                <div class="step_content">
                                    <div class="item item_wenzi">
                                        ...
                                        <div class="step_value"><span></span><a href="javascript:;" class="edit_category" ectype="edit_category"><i class="icon icon-edit"></i></a><a href="javascript:void(0);" class="category_dialog">添加扩展分类</a></div>
                                    </div>	
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="step_value">
                                            ...
                                            <input type="button" class="button mr10" value="扫码入库信息" data-role="edit_scan_code"<?php if ($this->_var['form_act'] == 'insert'): ?> style="display:none;"<?php endif; ?>>
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="step_value">
											<input type="text" name="goods_name" class="text" autocomplete="off" value="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" style="color:<?php echo $this->_var['goods_name_color']; ?>;"/>
...
?>
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="step_value"><input type="text" name="warn_number" class="text w150" autocomplete="off" value="<?php echo $this->_var['goods']['warn_number']; ?>"/><div class="notic">当库存少于或等于库存警告设置数量时，前台会提示</div></div>
                                    </div>
                                    <div class="item">
                                                ...
                                                <div class="brand-top">
                                                    <div class="letter">
                                                        <ul>
                                                            ...
                                                            <?php $_from = $this->_var['letter']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'letter_0_44484500_1522815325');if (count($_from)):
    foreach ($_from AS $this->_var['letter_0_44484500_1522815325']):
?>
                                                            <li><a href="javascript:void(0);" data-letter="<?php echo $this->_var['letter_0_44484500_1522815325']; ?>"><?php echo $this->_var['letter_0_44484500_1522815325']; ?></a></li>
                                                            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                ...
                                <div class="step_content" style="display:none;">
                                    <div class="item">
                                        ...
                                        <div class="step_value" style="margin-bottom:0px;">
                                        	...
                                        	<?php if ($this->_var['goods']['user_id']): ?>
                                            <div class="notic">最高可设置<em id="give_integral"><?php echo empty($this->_var['goods']['use_give_integral']) ? '0' : $this->_var['goods']['use_give_integral']; ?></em>消费积分</div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="item">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="step_value" style="margin-bottom:0px;">
                                            ...
                                            <?php if ($this->_var['goods']['user_id']): ?>
                                            <div class="notic">最高可设置<em id="rank_integral"><?php echo empty($this->_var['goods']['use_rank_integral']) ? '0' : $this->_var['goods']['use_rank_integral']; ?></em>等级积分</div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="item">
...
?>
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="step_value"><input type="text" name="keywords" class="text" autocomplete="off" value="<?php echo htmlspecialchars($this->_var['goods']['keywords']); ?>"/><div class="notic">商品关键词请用空格分隔</div></div>
                                    </div>
                                    <div class="item">
                                    ...
                                    <div class="item">
                                        <div class="step_label">商品标签：</div>
                                        <div class="step_value">
                                            <textarea class="textarea" name="goods_product_tag"><?php echo htmlspecialchars($this->_var['goods']['goods_product_tag']); ?></textarea><div class="notic">请用','号分割；例：商品好看,很实用,材料很好...（注意逗号要使用英文逗号）</div>
                                        </div>
                                    </div>
                                    <div class="item">
                        ...
                        <div class="step_four" style="display:none;" ectype="step" data-step="5">
                            ...
                            <div class="step">
                                <div class="step_title"><i class="ui-step"></i><h3>商品属性</h3></div>
...
?>
                        ...
                        <div class="step_last" style="display:none;" ectype="step" data-step="6">
                            <div class="step" ectype="filter" data-filter="goods">
                                <div class="step_title"><i class="ui-step"></i><h3>关联商品</h3></div>
                                <div class="step_content">
                                    <!--通用部分 start-->
...
?>
                            ...
                            <div class="step" ectype="filter" data-filter="goods">
                                <div class="step_title"><i class="ui-step"></i><h3>配件</h3></div>
                                <div class="step_content">
                                    <!--通用部分 start-->
                                    <div class="goods_search_div">
                                        <div class="search_select">
                                    ...
                                    <div class="move_div">
                                        <div class="move_left">
                                            ...
                                            <div class="move_handle">
                                                <a href="javascript:void(0);" class="btn btn25 moveAll" ectype="moveAll">全选</a>
                                                <span class="purchase_txt"><span>限购：</span><input type="text" name="group_number" class="text w40" autocomplete="off" /><span>件</span></span>
                                                <span class="pj_price_txt"><span>价格：</span><input type="text" name="price2" class="text w40" autocomplete="off" /><span>元</span></span>
                                                <a href="javascript:void(0);" class="btn btn25 red_btn" ectype="sub" data-operation="add_group_goods">确定</a>
                                            </div>
                                        </div>
                                        <div class="move_middle">
                                            <div class="checkbox_items">
                                                <div class="checkbox_item">
                                                    <input type="radio" name="group2" class="ui-radio" id="coll" checked value="1" />
                                                    <label for="coll" class="ui-radio-label">推荐搭配</label>
                                                </div>
                                                <div class="checkbox_item">
                                                    <input type="radio" name="group2" class="ui-radio" id="com" value="2" />
                                                    <label for="com" class="ui-radio-label">人气组合</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="move_right">
...
?>
                                                        <li data-value="<?php echo $this->_var['group_goods']['goods_id']; ?>" data-text="<?php echo $this->_var['group_goods']['goods_name']; ?>">
                                                        	<i class="sc_icon sc_icon_no"></i>
                                                            <a href="javascript:void(0);"><?php echo $this->_var['group_goods']['goods_name']; ?></a>
                                                        </li>
                                                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="move_handle">
                                                <a href="javascript:void(0);" class="btn btn25 moveAll" ectype="moveAll">全选</a>
                                                <a href="javascript:void(0);" class="btn btn25 btn_red" ectype="sub" data-operation="drop_group_goods">移除配件</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="step" ectype="filter" data-filter="article">
                                <div class="step_title"><i class="ui-step"></i><h3>关联文章</h3></div>
                                <div class="step_content">
                                    <div class="goods_search_div">
...
?>
                            ...
                            <div class="step" ectype="filter" data-filter="area">
                                <div class="step_title"><i class="ui-step"></i><h3>关联地区</h3></div>
                                <div class="step_content">
                                    <div class="goods_search_div">
                                        <div class="search_select">
		...
		var show_step = function(type,num,valid,obj){
			...
			if(obj != null){
				...
				if(num=="8"){
                                  ...
                                  window.location.href="gettaobao.php?cat_id="+$("input[name='cat_id']").val()+"&model="+$("form[name='theForm'] :input[name='model_inventory']").val(); 
		...
		validfunc = function (num){
			...
			if(num == 3){
				...
				if($("input[name='shop_price']").val() == 0){
					error_div("input[name='shop_price']","商品价格不能为0");
					return false;
				}
...
?>
	...
	*/
	...
	$(document).on("click","#goodsMobile .albumContent li",function(){
			...
			$.jqueryAjax('goods.php', 'act=scan_code&bar_code='+bar_code, function(data){
				if(data['error'] == 1){
					...
					if(data['goods_info']['goods_desc']){
						$(".panel-pc").html(data['goods_info']['goods_desc']);
					}
	...
	$(document).on("click","a[ectype='add_attr_img']",function(){
		...
		$.jqueryAjax('dialog.php', 'act=add_attr_img' + '&goods_id=' + goods_id + '&attr_id=' + attr_id + '&goods_attr_name=' + attr_value + '&goods_attr_id=' + goods_attr_id, function(data){
			var content = data.content;
			pb({
				id:"categroy_dialog",
				title:"上传属性图片",
