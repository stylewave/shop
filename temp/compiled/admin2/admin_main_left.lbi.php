<div class="admin-main-left">
    <div class="admincj_nav">
        ...
        <?php $_from = $this->_var['nav_top']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'nav_0_54888700_1522325229');if (count($_from)):
    foreach ($_from AS $this->_var['nav_0_54888700_1522325229']):
?>
        <div class="navLeftTab" id="adminNavTabs_<?php echo $this->_var['nav_0_54888700_1522325229']['type']; ?>" style="display:none;">
            <?php $_from = $this->_var['nav_0_54888700_1522325229']['children']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('k', 'menu');$this->_foreach['foo'] = array('total' => count($_from), 'iteration' => 0);
...
?>
                        <li <?php if (($this->_foreach['childfoo']['iteration'] <= 1)): ?>class="curr"<?php endif; ?>><s></s><a href="javascript:void(0);" data-url="<?php echo $this->_var['child']['action']; ?>" data-param="<?php echo $this->_var['nav_0_54888700_1522325229']['type']; ?>|<?php echo $this->_var['key']; ?>" target="workspace"><?php echo $this->_var['child']['label']; ?></a></li>
